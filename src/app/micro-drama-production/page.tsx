...
export const metadata: Metadata = {
  ...
  keywords: ['micro drama production India', 'AI micro drama', 'mobile-first drama production India'],
  alternates: { canonical: 'https://www.thezyra.in/micro-drama-production' },
}
