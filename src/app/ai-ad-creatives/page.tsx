...
export const metadata: Metadata = {
  ...
  keywords: ['AI performance creatives India', 'AI ad production India', 'performance marketing video India'],
  alternates: { canonical: 'https://www.thezyra.in/ai-ad-creatives' },
}
