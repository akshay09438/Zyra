    ...
    <div className="bg-[#080808] text-white min-h-screen font-sans overflow-x-hidden antialiased">
      ...
      <section className="w-full bg-[#080808] overflow-hidden">
        <div style={{ textAlign: 'center', padding: 'clamp(60px, 8vw, 100px) clamp(32px, 6vw, 100px) clamp(48px, 6vw, 72px)' }}>
          ...
          >
            The creative force behind our cinematic productions
          </motion.p>
        </div>
        ...
        <div style={{ padding: '0 clamp(32px, 6vw, 100px) clamp(80px, 10vw, 120px)' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative', zIndex: 1, gridColumn: 1, gridRow: isMobile ? 1 : 1 }}>
              ...
              >
                A film director and executive producer, shaping powerful narratives across TVCs, digital films, corporate stories, short films and music videos. He has worked with brands like Boat and Zomato to creative collaborations with acclaimed industry personalities such as Imtiaz Ali, Akshay Kumar, Ravi Varman, Arshad Warsi and Vivek Oberoi, among others.
              </motion.p>

              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                {['Film Direction', 'Executive Production', 'TVCs', 'Brand Films', 'Music Videos'].map((tag, j) => (
                  <motion.span
                    key={tag}
                    initial={{ opacity: 0, y: 8, scale: 0.95 }}
                    whileInView={{ opacity: 1, y: 0, scale: 1 }}
